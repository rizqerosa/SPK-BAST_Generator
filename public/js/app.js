...
function autoGenerateDocNumbers(inputTahunVal) {
  ...
  const nextBast = maxBastNo + 1;
  const formattedBast = String(nextBast).padStart(3, "0") + `/BPS/1172/BAST/${yr}`;
